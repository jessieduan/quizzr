...
render: function() {
    return (
        React.createElement("div", {className: "singleExplanation"}, 
        React.createElement("div", {className: "explanationText"}, this.props.explanation["explanation"], " "), 
            React.createElement("div", {className: "explanationVoteBox"}, 
                React.createElement("div", null, 
...
render: function() {
    ...
    var controlExplanationBox = (this.state.selectedAnswer && explanationsArray.length > 0) ?
        (React.createElement("div", null, " ", explanationsArray[0]["explanation"])) : null;
